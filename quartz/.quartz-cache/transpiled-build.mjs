...
function slugifyFilePath(fp, excludeExt) {
  ...
  let slug2 = withoutFileExt
    .split("/")
    .map((segment) =>
      segment.replace(/\s/g, "-").replace(/%/g, "-percent").replace(/\?/g, "-q")
    )
    .join("/")
    .replace(/\/$/, "");
  return (
...
function coerceDate(fp, d) {
  let dt = new Date(d),
    invalidDate = isNaN(dt.getTime()) || dt.getTime() === 0;
  return (
    invalidDate &&
      d !== void 0 &&
      console.log(
...
Warning: found invalid date "${d}" in \`${fp}\`. Supported formats: https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Date#date_time_string_format`)
    ...
    invalidDate ? new Date() : dt
  );
}
__name(coerceDate, "coerceDate");
var CreatedModifiedDate = __name((userOpts) => {
        ...
        () => {
          ...
          return async (_tree, file) => {
            let created,
              ...
              fullFp = path2.posix.join(file.cwd, fp);
            for (let source of opts.priority)
              if (source === "filesystem") {
                let st = await fs.promises.stat(fullFp);
          ...
          () => (tree, file) => {
            ...
            visit(tree, "element", (node, _index, _parent) => {
              if (
                ...
                let isInternal = !(isAbsoluteUrl(dest) || dest.startsWith("#"));
                if (isInternal) {
                  ...
                  outgoing.add(simple), (node.properties["data-slug"] = simple);
                }
                opts.prettyLinks &&
                  isInternal &&
...
var wikilinkRegex = new RegExp(
  ...
  tagRegex = new RegExp(/(?:^| )#((?:[-_\p{L}\d])+(?:\/[-_\p{L}\d]+)*)/, "gu"),
  blockReferenceRegex = new RegExp(/\^([A-Za-z0-9]+)$/, "g"),
              ...
              findAndReplace(tree, wikilinkRegex, (value, ...capture) => {
                ...
                if (value.startsWith("!")) {
                  ...
                  if (
                    ...
                    if (ext === "") {
                      let block = anchor.slice(1);
                      return {
                        type: "html",
                        data: { hProperties: { transclude: !0 } },
                        value: `<blockquote class="transclude" data-url="${url2}" data-block="${block}"><a href="${
                          url2 + anchor
...
`),
      ...
      htmlPlugins() {
        ...
        return (
          opts.parseBlockReferences &&
            plugins.push(() => {
              let inlineTagTypes = new Set(["p", "li"]),
                blockTagTypes = new Set(["blockquote"]);
              return (tree, file) => {
                (file.data.blocks = {}),
                  visit2(tree, "element", (node, index, parent) => {
                    if (blockTagTypes.has(node.tagName)) {
                      let nextChild = parent?.children.at(index + 2);
                      if (nextChild && nextChild.tagName === "p") {
                        let text = nextChild.children.at(0);
                        if (text && text.value && text.type === "text") {
                          let matches = text.value.match(blockReferenceRegex);
                          if (matches && matches.length >= 1) {
                            parent.children.splice(index + 2, 1);
                            let block = matches[0].slice(1);
                            Object.keys(file.data.blocks).includes(block) ||
                              ((node.properties = {
                                ...node.properties,
                                id: block,
                              }),
                      ...
                      if (last && last.value && typeof last.value == "string") {
                        let matches = last.value.match(blockReferenceRegex);
                        if (matches && matches.length >= 1) {
...
var relrefRegex = new RegExp(
  ...
  inlineLatexRegex = new RegExp(/\\\\\((.+?)\\\\\)/, "g"),
  blockLatexRegex = new RegExp(
    /(?:\\begin{equation}|\\\\\(|\\\\\[)([\s\S]*?)(?:\\\\\]|\\\\\)|\\end{equation})/,
    "g"
  ),
  quartzLatexRegex = new RegExp(/\$\$[\s\S]*?\$\$|\$.*?\$/, "g");
...
/*# sourceMappingURL=data:application/json;charset=utf-8;base64, */`;
...
/*# sourceMappingURL=data:application/json;charset=utf-8;base64, */`;
...
function Backlinks({ fileData, allFiles, displayClass }) {
  ...
  return jsxs("div", {
    class: `backlinks ${displayClass ?? ""}`,
    children: [
      jsx4("h3", { children: "Backlinks" }),
      jsx4("ul", {
        class: "overflow",
        children:
          backlinkFiles.length > 0
            ...
            : jsx4("li", { children: "No backlinks found" }),
      }),
    ],
  });
}
...
function pageResources(baseDir, staticResources) {
  let contentIndexScript = `const fetchData = fetch(\`${joinSegments(
    baseDir,
...
function renderPage(slug2, componentData, components, pageResources2) {
  visit4(componentData.tree, "element", (node, _index, _parent) => {
    if (
      ...
      let inner = node.children[0],
        blockSlug = inner.properties?.["data-slug"],
        blockRef = node.properties.dataBlock,
        blockNode = componentData.allFiles.find((f) => f.slug === blockSlug)
          ?.blocks?.[blockRef];
      blockNode &&
  ...
  let {
    ...
    Body2 = Body_default(),
    LeftComponent = jsx5("div", {
      class: "left sidebar",
      children: left.map((BodyComponent) =>
        jsx5(BodyComponent, { ...componentData })
      ),
    }),
    RightComponent = jsx5("div", {
      class: "right sidebar",
                  ...
                  children: [
                    ...
                    jsxs2("div", {
                      ...
                      children: [
                          ...
                          children: [
                            jsx5(Header2, {
                              ...
                              children: header.map((HeaderComponent) =>
                                jsx5(HeaderComponent, { ...componentData })
                              ),
                            }),
                            jsx5("div", {
                              class: "popover-hint",
                        ...
                        jsx5(Content2, { ...componentData }),
                        jsx5("a", {
                          class: "twitter-share-button",
                          href: `https://twitter.com/intent/tweet?text=${componentData.fileData.frontmatter?.title}&url=https://${componentData.cfg.baseUrl}/${componentData.fileData.slug}&via=zeyadetman`,
                          children: "Share it on Twitter",
                        }),
                        Backlinks_default()(componentData),
                      ],
                    }),
                    RightComponent,
                  ],
                }),
                jsx5(Footer, { ...componentData }),
              ],
            }),
            jsx5("script", {
  ...
  if (tag === "") {
    ...
    return jsxs6("div", {
      ...
      children: [
        ...
        jsxs6("p", { children: ["Found ", tags.length, " total tags."] }),
        jsx11("div", {
    ...
    return jsxs6("div", {
      ...
      children: [
        ...
        jsxs6("p", {
          children: [pluralize(pages.length, "item"), " with this tag."],
        }),
...
import { jsx as jsx14, jsxs as jsxs9 } from "preact/jsx-runtime";
function NotFound() {
  return jsxs9("article", {
    class: "popover-hint",
    children: [
      jsx14("h1", { children: "404" }),
      jsx14("p", { children: "Either this page is private or doesn't exist." }),
    ],
  });
}
__name(NotFound, "NotFound");
var __default = __name(() => NotFound, "default");
...
function ArticleTitle({ fileData, displayClass }) {
  ...
  return title
    ? jsx15("h1", {
        class: `article-title ${displayClass ?? ""}`,
        children: title,
      })
    : null;
}
    ...
    children: [
      ...
      jsx16("label", {
        ...
        children: jsxs10("svg", {
          ...
          xmlSpace: "preserve",
          children: [
            jsx16("title", { children: "Light mode" }),
            jsx16("path", {
      ...
      jsx16("label", {
        ...
        children: jsxs10("svg", {
          ...
          xmlSpace: "preserve",
          children: [
            jsx16("title", { children: "Dark mode" }),
            jsx16("path", {
...
import { jsx as jsx17, jsxs as jsxs11 } from "preact/jsx-runtime";
var Head_default = __name(() => {
  function Head({ cfg, fileData, externalResources }) {
    let title = fileData.frontmatter?.title ?? "Untitled",
      ...
      path13 = new URL(`https://${cfg.baseUrl ?? "example.com"}`).pathname,
      baseDir = fileData.slug === "404" ? path13 : pathToRoot(fileData.slug),
      iconPath = joinSegments(baseDir, "static/icon.png"),
      ogImagePath = `https://${cfg.baseUrl}/static/og-image.png`;
    return jsxs11("head", {
      children: [
        jsx17("title", { children: title }),
        jsx17("meta", { charSet: "utf-8" }),
        jsx17("meta", {
          name: "viewport",
          content: "width=device-width, initial-scale=1.0",
        }),
        jsx17("meta", { property: "og:title", content: title }),
        jsx17("meta", { property: "og:description", content: description }),
        cfg.baseUrl &&
          jsx17("meta", { property: "og:image", content: ogImagePath }),
        jsx17("meta", { property: "og:width", content: "1200" }),
        jsx17("meta", { property: "og:height", content: "675" }),
        jsx17("link", { rel: "icon", href: iconPath }),
        jsx17("meta", { name: "description", content: description }),
        jsx17("meta", { name: "generator", content: "Quartz" }),
        jsx17("link", {
          rel: "preconnect",
          href: "https://fonts.googleapis.com",
        }),
        jsx17("link", { rel: "preconnect", href: "https://fonts.gstatic.com" }),
        css.map((href) =>
          jsx17(
            "link",
...
function PageTitle({ fileData, cfg, displayClass }) {
  ...
  return jsx18("h1", {
    class: `page-title ${displayClass ?? ""}`,
    children: jsx18("a", { href: baseDir, children: title }),
  });
}
  ...
  function ContentMetadata({ cfg, fileData, displayClass }) {
    ...
    if (text) {
      ...
      return (
        ...
        jsx19("p", {
          class: `content-meta ${displayClass ?? ""}`,
...
function Spacer({ displayClass }) {
  return jsx20("div", { class: `spacer ${displayClass ?? ""}` });
}
...
/*# sourceMappingURL=data:application/json;charset=utf-8;base64, */`;
var toc_default = `
button#toc {
  background-color: transparent;
  border: none;
...
/*# sourceMappingURL=data:application/json;charset=utf-8;base64, */`;
    ...
    ? jsxs12("div", {
        ...
        children: [
          jsxs12("button", {
            ...
            id: "toc",
            children: [
              jsx21("h3", { children: "Table of Contents" }),
              jsx21("svg", {
                xmlns: "http://www.w3.org/2000/svg",
                width: "24",
                height: "24",
                ...
                class: "fold",
                children: jsx21("polyline", { points: "6 9 12 15 18 9" }),
              }),
            ],
          }),
          jsx21("div", {
...
function LegacyTableOfContents({ fileData }) {
  return fileData.toc
    ? jsxs12("details", {
        ...
        children: [
          jsx21("summary", {
            children: jsx21("h3", { children: "Table of Contents" }),
          }),
          jsx21("ul", {
            children: fileData.toc.map((tocEntry) =>
              jsx21(
...
var FileNode = class _FileNode {
  ...
  insert(file) {
    if (file.path.length === 1)
      if (file.path[0] !== "index.md")
        this.children.push(
          new _FileNode(file.file.frontmatter.title, file.file, this.depth + 1)
        );
      else {
        let title = file.file.frontmatter?.title;
        title &&
          title !== "index" &&
          file.path[0] === "index.md" &&
          (this.displayName = title);
      }
    else {
      let next = file.path[0];
      ...
      let newChild = new _FileNode(next, void 0, this.depth + 1);
      newChild.insert(file), this.children.push(newChild);
    }
  }
  add(file, splice = 0) {
  ...
  map(mapFn) {
    mapFn(this), this.children.forEach((child) => child.map(mapFn));
  }
  getFolderPaths(collapsed) {
    let folderPaths = [],
      traverse = __name((node, currentPath) => {
        if (!node.file) {
          let folderPath = currentPath + (currentPath ? "/" : "") + node.name;
          folderPath !== "" &&
            folderPaths.push({ path: folderPath, collapsed }),
            node.children.forEach((child) => traverse(child, folderPath));
        }
      }, "traverse");
    return traverse(this, ""), folderPaths;
  }
  sort(sortFn) {
...
function ExplorerNode({ node, opts, fullPath, fileData }) {
  let folderBehavior = opts.folderClickBehavior,
    isDefaultOpen = opts.folderDefaultState === "open",
    pathOld = fullPath || "",
    folderPath = "";
  return (
    node.name !== "" && (folderPath = `${pathOld}/${node.name}`),
    jsx22("li", {
      children: node.file
        ? jsx22(
            "li",
        ...
        : jsxs13("div", {
            children: [
                ...
                jsxs13("div", {
                  ...
                  children: [
                    jsx22("svg", {
                      ...
                      "stroke-linejoin": "round",
                      class: "folder-icon",
                      children: jsx22("polyline", { points: "6 9 12 15 18 9" }),
                    }),
                    jsx22(
                      "div",
                      {
              ...
              jsx22("div", {
                class: `folder-outer ${
                  node.depth === 0 || isDefaultOpen ? "open" : ""
                }`,
                children: jsx22("ul", {
                  style: { paddingLeft: node.name !== "" ? "1.4rem" : "0" },
                  class: "content",
                  "data-folderul": folderPath,
                  children: node.children.map((childNode, i) =>
                    jsx22(
                      ExplorerNode,
                      { node: childNode, opts, fullPath: folderPath, fileData },
                      i
                    )
                  ),
                }),
...
var defaultOptions9 = {
    ...
    sortFn: (a, b) =>
      (!a.file && !b.file) || (a.file && b.file)
        ? a.displayName.localeCompare(b.displayName, void 0, {
            numeric: !0,
            sensitivity: "base",
          })
        : a.file && !b.file
  ...
  Explorer_default = __name((userOpts) => {
    let opts = { ...defaultOptions9, ...userOpts },
      fileTree,
      jsonTree;
      ...
      if (!fileTree) {
        ...
        if (opts.order)
          for (let i = 0; i < opts.order.length; i++) {
            let functionName = opts.order[i];
            functions[functionName] &&
              fileTree[functionName].call(fileTree, functions[functionName]);
          }
        let folders = fileTree.getFolderPaths(
            ...
            jsxs14("button", {
              ...
              children: [
                ...
                jsx23("svg", {
                  ...
                  "stroke-linejoin": "round",
                  class: "fold",
                  children: jsx23("polyline", { points: "6 9 12 15 18 9" }),
                }),
              ],
            }),
            jsx23("div", {
              ...
              children: jsxs14("ul", {
                ...
                id: "explorer-ul",
                children: [
                  jsx23(ExplorerNode, { node: fileTree, opts, fileData }),
                  jsx23("li", { id: "explorer-end" }),
                ],
              }),
            }),
          ],
...
var defaultOptions10 = {
  ...
  Graph_default = __name((opts) => {
    function Graph({ displayClass }) {
      let localGraph = { ...defaultOptions10.localGraph, ...opts?.localGraph },
        globalGraph = { ...defaultOptions10.globalGraph, ...opts?.globalGraph };
      return jsxs15("div", {
        class: `graph ${displayClass ?? ""}`,
        children: [
          jsx25("h3", { children: "Graph View" }),
          jsxs15("div", {
            class: "graph-outer",
            children: [
              jsx25("div", {
...
var Search_default = __name(() => {
  function Search({ displayClass }) {
    return jsxs16("div", {
      class: `search ${displayClass ?? ""}`,
      children: [
        jsxs16("div", {
          id: "search-icon",
          children: [
            jsx26("p", { children: "Search" }),
            jsx26("div", {}),
            jsxs16("svg", {
              tabIndex: 0,
              ...
              children: [
                jsx26("title", { id: "title", children: "Search" }),
                jsx26("desc", { id: "desc", children: "Search" }),
                jsxs16("g", {
                  class: "search-path",
                  fill: "none",
                  children: [
        ...
        jsx26("div", {
          ...
          children: jsxs16("div", {
            ...
            children: [
              ...
              jsx26("div", { id: "results-container" }),
            ],
          }),
        }),
      ],
...
/*# sourceMappingURL=data:application/json;charset=utf-8;base64, */`;
var version = "4.1.0";
      ...
      children: [
        ...
        jsx27("ul", {
          children: Object.entries(links).map(([text, link]) =>
            jsx27("li", {
              children: jsx27("a", { href: link, children: text }),
            })
          ),
        }),
      ],
...
var DesktopOnly_default = __name((component) => {
  if (component) {
    let DesktopOnly2 = function (props) {
      return jsx28(Component, { displayClass: "desktop-only", ...props });
    };
...
var MobileOnly_default = __name((component) => {
  if (component) {
    let MobileOnly2 = function (props) {
      return jsx29(Component, { displayClass: "mobile-only", ...props });
    };
...
var defaultOptions11 = __name(
  ...
  RecentNotes_default = __name((userOpts) => {
    function RecentNotes({ allFiles, fileData, displayClass, cfg }) {
      let opts = { ...defaultOptions11(cfg), ...userOpts },
        pages = allFiles.filter(opts.filter).sort(opts.sort),
        remaining = Math.max(0, pages.length - opts.limit);
      return jsxs18("div", {
        class: `recent-notes ${displayClass ?? ""}`,
        children: [
          jsx30("h3", { children: opts.title }),
          jsx30("ul", {
            class: "recent-ul",
                ...
                children: jsxs18("div", {
                  ...
                  children: [
                    ...
                    page.dates &&
                      jsx30("p", {
                        class: "meta",
                        children: jsx30(Date2, { date: getDate(cfg, page) }),
                      }),
                    jsx30("ul", {
                      class: "tags",
                      children: tags.map((tag) =>
...
/*# sourceMappingURL=data:application/json;charset=utf-8;base64, */`;
import {
...
function findCurrentFile(allFiles, folderName) {
  return allFiles.find((file) => {
    if (file.slug?.endsWith("index")) {
      let folderParts = file.filePath?.split("/");
      if (folderParts && folderParts[folderParts?.length - 2] === folderName)
        return !0;
    }
  });
}
__name(findCurrentFile, "findCurrentFile");
var Breadcrumbs_default = __name((opts) => {
  let options2 = { ...defaultOptions12, ...opts };
  function Breadcrumbs({ fileData, allFiles, displayClass }) {
    if (options2.hideOnRoot && fileData.slug === "index")
      return jsx31(Fragment7, {});
    let crumbs = [formatCrumb(options2.rootName, fileData.slug, "/")],
      slugParts = fileData.slug?.split("/");
    if (slugParts) {
      let currentPath = "";
      for (let i = 0; i < slugParts.length - 1; i++) {
        let currentTitle = slugParts[i];
        if (options2?.resolveFrontmatterTitle) {
          let currentFile = findCurrentFile(allFiles, currentTitle);
          currentFile && (currentTitle = currentFile.frontmatter.title);
        }
        currentPath += slugParts[i] + "/";
        let crumb = formatCrumb(currentTitle, fileData.slug, currentPath);
        crumbs.push(crumb);
      }
    ...
    return jsx31("nav", {
      ...
      children: crumbs.map((crumb, index) =>
        jsxs19("div", {
          ...
          children: [
            jsx31("a", { href: crumb.path, children: crumb.displayName }),
            index !== crumbs.length - 1 &&
              jsx31("p", { children: ` ${options2.spacerSymbol} ` }),
          ],
        })
      ),
    });
...
var sharedPageComponents = {
  ...
  defaultContentPageLayout = {
    ...
    left: [
      ...
      DesktopOnly_default(Explorer_default({ title: "All Notes" })),
    ],
    right: [
      Graph_default(),
      DesktopOnly_default(RecentNotes_default({ limit: 3 })),
    ],
  },
  defaultListPageLayout = {
    ...
    right: [
      DesktopOnly_default(RecentNotes_default({ limit: 5 })),
      MobileOnly_default(Explorer_default({ title: "All Notes" })),
    ],
  };
  ...
  return {
    ...
    async emit(ctx, content, resources, emit) {
      ...
      for (let [tree, file] of content) {
        ...
        slug2 === "index" && (containsIndex = !0);
        let externalResources = pageResources(pathToRoot(slug2), resources),
          componentData = {
            fileData: file.data,
            externalResources,
            cfg,
    ...
    async emit(ctx, content, resources, emit) {
      ...
      for (let tag of tags) {
        let slug2 = joinSegments("tags", tag),
          externalResources = pageResources(pathToRoot(slug2), resources),
...
<rss version="2.0">
    <channel>
      ...
      <link>${root}</link>
      <description>${
        limit ? `Last ${limit} notes` : "Recent notes"
          ...
          (opts?.includeEmptyFiles ||
            ...
            linkIndex.set(slug2, {
              ...
              richContent: opts?.rssFullHtml
                ? escapeHTML(toHtml2(tree, { allowDangerousHtml: !0 }))
                : void 0,
              date,
      ...
      for (let [_tree, file] of content) {
        let ogSlug = simplifySlug(file.data.slug),
          dir = path8.posix.relative(
            argv.directory,
            path8.dirname(file.data.filePath)
          ),
          aliases =
        ...
        let slugs = aliases.map((alias) => path8.posix.join(dir, alias)),
          permalink = file.data.frontmatter?.permalink;
        typeof permalink == "string" && slugs.push(permalink);
        for (let slug2 of slugs) {
          let redirUrl = resolveRelative(slug2, file.data.slug),
            fp = await emit({
              content: `
            <!DOCTYPE html>
            <html lang="en-us">
...
.page > #quartz-body .sidebar.right {
  right: calc((100vw - 600px) / 2 - 380px);
}
@media all and (max-width: 1360px) {
  .page > #quartz-body .sidebar.right > * {
    flex: 1;
...
/*# sourceMappingURL=data:application/json;charset=utf-8;base64, */`;
...
var defaultOptions14 = { fontOrigin: "googleFonts" },
  ComponentResources = __name((opts) => {
    let { fontOrigin } = { ...defaultOptions14, ...opts };
    return {
  ...
  return {
    ...
    async emit(ctx, _content, resources, emit) {
      let cfg = ctx.cfg.configuration,
        slug2 = "404",
        path13 = new URL(`https://${cfg.baseUrl ?? "example.com"}`).pathname,
        externalResources = pageResources(path13, resources),
        [tree, vfile] = defaultProcessedContent({
          slug: slug2,
          text: "Not Found",
...
var config = {
    configuration: {
      pageTitle: "\u{1F468}\u{1F3FB}\u200D\u{1F4BB} Zeyad's Notes",
      enableSPA: !0,
      enablePopovers: !0,
    ...
    plugins: {
      transformers: [
        FrontMatter(),
        TableOfContents(),
        CreatedModifiedDate({ priority: ["git", "frontmatter", "filesystem"] }),
        SyntaxHighlighting(),
...
async function buildQuartz(argv, mut, clientRefresh) {
  ...
  if (
    ...
    console.log(
      chalk5.green(`Done processing ${fps.length} files in ${perf.timeSince()}`)
    ),
    release(),
    argv.serve)
  )
...
async function startServing(ctx, mut, initialContent, clientRefresh) {
  ...
  async function rebuild(fp, action) {
    ...
    let perf = new PerfTimer();
    console.log(chalk5.yellow("Detected change, rebuilding..."));
    try {
      ...
      await rimraf(argv.output),
        await emitContent(ctx, filteredContent),
        console.log(chalk5.green(`Done rebuilding in ${perf.timeSince()}`));
    } catch {
      console.log(
        chalk5.yellow("Rebuild failed. Waiting on a change to fix the error...")
      );
    }
